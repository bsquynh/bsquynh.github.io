// File: chidinh.js
// Dữ liệu chỉ định MRI và CT Scanner tách riêng lẻ từng kỹ thuật theo Quyết định

const chiDinhData = [
    // =========================================================================
    // I. DANH MỤC MRI - QUYẾT ĐỊNH 978/QĐ-BIH (TÁCH RIÊNG 14 KỸ THUẬT)
    // =========================================================================
    {
        maDV: "MRI_01",
    ...
    {
        maDV: "MRI_08",
        tenDV: "Chụp cộng hưởng từ tầng bụng có tiêm chất tương phản (gồm: gan - mật, tụy, lách, thận, dạ dày - tá tràng...) (≥ 3T)",
        nhom: "Cộng hưởng từ (MRI)",
        danhSachICD: [
    ...
    {
        maDV: "MRI_09",
        tenDV: "Chụp cộng hưởng từ vùng chậu (gồm: tử cung - phần phụ, tiền liệt tuyến, đại tràng chậu hông, trực tràng, các khối u vùng chậu...) (≥ 3T)",
        nhom: "Cộng hưởng từ (MRI)",
        danhSachICD: [
    ...
    // =========================================================================
    // II. DANH MỤC CT SCANNER (TÁCH RIÊNG 17 KỸ THUẬT ĐỘC LẬP)
    // =========================================================================
    {
        maDV: "CT_01",
    ...
    {
        maDV: "CT_03",
        tenDV: "Chụp CT lồng ngực không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
    ...
    {
        maDV: "CT_04",
        tenDV: "Chụp CT lồng ngực có tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "T18.1", tenBenh: "Dị vật trong thực quản" },
            { maICD: "J18.9", tenBenh: "Viêm phổi, không đặc hiệu" },
    ...
    {
        maDV: "CT_05",
        tenDV: "Chụp CT bụng - tiểu khung thường quy (từ 1 - 32 dãy) không có thuốc cản quang",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            ...
            { maICD: "K57.0", tenBenh: "Bệnh túi thừa của ruột non có thủng và áp xe" },
            { maICD: "K57.1", tenBenh: "Bệnh túi thừa của ruột non, không thủng hay áp xe" },
            { maICD: "K57.2", tenBenh: "Bệnh túi thừa của đại tràng có thủng và áp xe" },
            { maICD: "K57.3", tenBenh: "Bệnh túi thừa của đại tràng không thủng hay áp xe" },
            { maICD: "K57.4", tenBenh: "Bệnh túi thừa của ruột non và đại tràng có thủng và áp xe" },
            { maICD: "K57.5", tenBenh: "Bệnh túi thừa của ruột non và đại tràng không thủng hay áp xe" },
            { maICD: "K57.8", tenBenh: "Bệnh túi thừa của ruột, vị trí không xác định có thủng và áp xe" },
            { maICD: "K57.9", tenBenh: "Bệnh túi thừa của ruột, vị trí không xác định không thủng hay áp xe" },
    ...
    {
        maDV: "CT_06",
        tenDV: "Chụp CT bụng - tiểu khung thường quy (từ 1 - 32 dãy) có thuốc cản quang",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "D37.1", tenBenh: "U tân sinh chưa rõ tính chất của dạ dày" },
            { maICD: "D37.2", tenBenh: "U tân sinh chưa rõ tính chất của ruột non" },
    ...
    {
        maDV: "CT_09",
        tenDV: "Chụp CT xương chi không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
    ...
    {
        maDV: "CT_10",
        tenDV: "Chụp CT khớp thường quy không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "S72.1", tenBenh: "Gãy mấu chuyển" },
            { maICD: "S82.6", tenBenh: "Gãy xương bên mắt cá chân" },
    ...
    {
        maDV: "CT_11",
        tenDV: "Chụp CT cột sống cổ không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "M48.0", tenBenh: "Hẹp ống sống" },
            ...
            { maICD: "S19.7", tenBenh: "Tổn thương phức tạp của cổ" },
            { maICD: "S19.8", tenBenh: "Tổn thương đặc hiệu khác của cổ" },
            { maICD: "S19.9", tenBenh: "Tổn thương không đặc hiệu của cổ" },
            { maICD: "S17", tenBenh: "Tổn thương giập nát của cổ" },
            { maICD: "S17.0", tenBenh: "Tổn thương giập nát của thanh quản và phế quản" },
            { maICD: "S17.8", tenBenh: "Tổn thương giập nát của các phần khác của cổ" },
            { maICD: "S17.9", tenBenh: "Tổn thương giập nát của cổ, phần không xác định" },
            { maICD: "J38.6", tenBenh: "Hẹp thanh quản" },
            { maICD: "J38.0", tenBenh: "Liệt dây thanh âm và thanh quản" },
            { maICD: "M89.2", tenBenh: "Các rối loạn khác về sự phát triển và tăng trưởng của xương" },
            { maICD: "M89.8", tenBenh: "Các rối loạn đặc hiệu khác của xương" },
            { maICD: "M89.9", tenBenh: "Các rối loạn xương không đặc hiệu" },
            { maICD: "R22.1", tenBenh: "Sưng khu trú, khối và cục ở cổ" },
            { maICD: "S11", tenBenh: "Vết thương hở của cổ" },
            { maICD: "S11.0", tenBenh: "Vết thương hở bao gồm thanh quản và khí quản" },
            { maICD: "S11.2", tenBenh: "Vết thương hở bao gồm hầu và thực quản phần cổ" },
            { maICD: "S11.1", tenBenh: "Vết thương hở bao gồm tuyến giáp" },
            { maICD: "S11.7", tenBenh: "Đa vết thương hở của cổ" },
            { maICD: "S11.8", tenBenh: "Vết thương hở của các phần khác của cổ" },
            { maICD: "S11.9", tenBenh: "Vết thương hở của cổ, phần không xác định" }
        ]
    },
    {
        maDV: "CT_12",
        tenDV: "Chụp CT cột sống cổ có tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "C02", tenBenh: "U ác của phần khác và không xác định của lưỡi" },
            { maICD: "C02.0", tenBenh: "U ác mặt lưng của lưỡi" },
            { maICD: "C02.1", tenBenh: "U ác bờ của lưỡi" },
            { maICD: "C02.2", tenBenh: "U ác mặt bụng của lưỡi" },
            { maICD: "C02.3", tenBenh: "U ác hai phần ba trước của lưỡi, phần không xác định" },
            { maICD: "C02.4", tenBenh: "U ác của amidan đáy lưỡi" },
            { maICD: "C02.8", tenBenh: "U ác với tổn thương chồng lấn của lưỡi" },
            { maICD: "C02.9", tenBenh: "U ác của lưỡi không đặc hiệu" },
            { maICD: "J39.0", tenBenh: "Áp xe sau họng và áp xe cận họng" },
            { maICD: "J39.1", tenBenh: "Áp xe khác của họng" },
            ...
            { maICD: "Q18.0", tenBenh: "Tạo xoang, lỗ rò và nang nứt kẽ mang" },
            { maICD: "R22.1", tenBenh: "Sưng khu trú, khối và cục ở cổ" },
            { maICD: "Q89.2", tenBenh: "Các dị tật bẩm sinh của các tuyến nội tiết khác" },
            { maICD: "Q18.8", tenBenh: "Các dị tật bẩm sinh đặc hiệu khác ở mặt và cổ" },
            { maICD: "Q18.9", tenBenh: "Dị tật bẩm sinh ở mặt và cổ, không đặc hiệu" },
            { maICD: "C10", tenBenh: "U ác của hầu miệng" },
            { maICD: "C12", tenBenh: "U ác của xoang lê" },
            { maICD: "C13", tenBenh: "U ác của hạ hầu" },
            { maICD: "C14", tenBenh: "U ác vị trí khác và không rõ ràng của môi, khoang miệng và hầu" },
            { maICD: "C32", tenBenh: "U ác thanh quản" },
            { maICD: "C32.0", tenBenh: "U ác của thanh môn" },
            { maICD: "C32.1", tenBenh: "U ác vùng trên thanh môn" },
            { maICD: "C32.2", tenBenh: "U ác vùng dưới thanh môn" },
            { maICD: "C32.3", tenBenh: "U ác của sụn thanh quản" },
            { maICD: "C32.8", tenBenh: "U ác với tổn thương chồng lấn của thanh quản" },
            { maICD: "C32.9", tenBenh: "U ác của thanh quản, không đặc hiệu" },
            { maICD: "C77.0", tenBenh: "U ác của hạch của vùng đầu mặt cổ" }
        ]
    },
    {
        maDV: "CT_13",
        tenDV: "Chụp CT cột sống ngực không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "M48.0", tenBenh: "Hẹp ống sống" },
            { maICD: "M43.1", tenBenh: "Bệnh trượt đốt sống" },
    ...
    {
        maDV: "CT_14",
        tenDV: "Chụp CT cột sống thắt lưng không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "M48.0", tenBenh: "Hẹp ống sống" },
            { maICD: "M43.1", tenBenh: "Bệnh trượt đốt sống" },
    ...
    {
        maDV: "CT_15",
        tenDV: "Chụp CT hàm - mặt không tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "J32", tenBenh: "Viêm xoang mạn tính" },
            { maICD: "J32.8", tenBenh: "Viêm xoang mạn tính khác" },
            { maICD: "J32.9", tenBenh: "Viêm xoang mạn tính, không phân loại" },
            ...
            { maICD: "J33.0", tenBenh: "Polyp mũi" },
            { maICD: "J33.9", tenBenh: "Polyp mũi, không phân loại" },
            { maICD: "D14.0", tenBenh: "U lành tính tai giữa, hốc mũi và xoang phụ" },
            { maICD: "J01", tenBenh: "Viêm xoang cấp" },
            { maICD: "J01.0", tenBenh: "Viêm xoang hàm cấp" },
            { maICD: "J01.1", tenBenh: "Viêm xoang trán cấp" },
            { maICD: "J01.2", tenBenh: "Viêm xoang sàng cấp" },
            { maICD: "J01.3", tenBenh: "Viêm xoang bướm cấp" },
            { maICD: "J01.4", tenBenh: "Viêm toàn bộ xoang cấp" },
            { maICD: "J01.8", tenBenh: "Viêm đa xoang cấp tính khác" },
            { maICD: "J01.9", tenBenh: "Viêm xoang cấp, không phân loại" },
            { maICD: "C30.0", tenBenh: "Viêm xoang cấp, không phân loại" },
            { maICD: "C31", tenBenh: "U ác của các xoang phụ" },
            { maICD: "C31.0", tenBenh: "U ác của xoang hàm" },
            { maICD: "C31.1", tenBenh: "U ác của xoang sàng" },
            { maICD: "C31.2", tenBenh: "U ác của xoang trán" },
            { maICD: "C31.3", tenBenh: "U ác của xoang bướm" },
            { maICD: "C31.8", tenBenh: "U ác với tổn thương lan rộng của xoang phụ" },
            { maICD: "C31.9", tenBenh: "U ác của xoang phụ, không đặc hiệu" }
        ]
    },
    {
        maDV: "CT_16",
        tenDV: "Chụp CT hàm - mặt có tiêm thuốc cản quang (từ 1 - 32 dãy)",
        nhom: "Cắt lớp vi tính (CT)",
        danhSachICD: [
            { maICD: "D10.6", tenBenh: "U lành của hầu-mũi" },
            { maICD: "D11", tenBenh: "U lành của các tuyến nước bọt chính" },
            { maICD: "D11.0", tenBenh: "U lành của tuyến mang tai" },
            { maICD: "D11.7", tenBenh: "U lành của tuyến nước bọt chính khác" },
            { maICD: "D11.9", tenBenh: "U lành của tuyến nước bọt chính không đặc hiệu" },
            { maICD: "C07", tenBenh: "U ác tuyến mang tai" },
            { maICD: "C08", tenBenh: "U ác của các tuyến nước bọt chính khác và không xác định" },
            { maICD: "C08.0", tenBenh: "U ác của tuyến nước bọt dưới hàm dưới" },
            { maICD: "C08.1", tenBenh: "U ác của tuyến nước bọt dưới lưỡi" },
            { maICD: "C08.8", tenBenh: "U ác với tổn thương chồng lấn của tuyến nước bọt chính" },
            { maICD: "C08.9", tenBenh: "U ác của tuyến nước bọt chính, không đặc hiệu" },
            { maICD: "C11", tenBenh: "U ác của hầu-mũi" },
            { maICD: "S02", tenBenh: "Vỡ xương sọ và xương mặt" },
            { maICD: "S02.2", tenBenh: "Vỡ xương mũi" },
            { maICD: "S02.20", tenBenh: "Vỡ xương mũi, vỡ kín" },
            { maICD: "S02.21", tenBenh: "Vỡ xương mũi, vỡ hở" },
            { maICD: "S02.4", tenBenh: "Vỡ xương má và xương hàm" },
            { maICD: "S02.40", tenBenh: "Vỡ xương má và xương hàm, vỡ kín" },
            { maICD: "S02.41", tenBenh: "Vỡ xương má và xương hàm, vỡ hở" },
            { maICD: "S02.6", tenBenh: "Vỡ xương hàm" },
            { maICD: "S02.60", tenBenh: "Vỡ xương hàm, vỡ kín" },
            { maICD: "S02.61", tenBenh: "Vỡ xương hàm, vỡ hở" },
            { maICD: "S02.7", tenBenh: "Vỡ nhiều mảnh của xương sọ và xương mặt" },
            { maICD: "S02.70", tenBenh: "Vỡ nhiều mảnh của xương sọ và xương mặt, vỡ kín" },
            { maICD: "S02.71", tenBenh: "Vỡ nhiều mảnh của xương sọ và xương mặt, vỡ hở" },
            { maICD: "S02.8", tenBenh: "Vỡ các xương khác của sọ và mặt" },
            { maICD: "S02.80", tenBenh: "Vỡ các xương khác của sọ và mặt, vỡ kín" },
            { maICD: "S02.81", tenBenh: "Vỡ các xương khác của sọ và mặt, vỡ hở" },
            { maICD: "S02.9", tenBenh: "Vỡ các xương sọ và xương mặt, phần không xác định" },
            { maICD: "S02.90", tenBenh: "Vỡ các xương sọ và xương mặt, phần không xác định, vỡ kín" },
            { maICD: "S02.91", tenBenh: "Vỡ các xương sọ và xương mặt, phần không xác định, vỡ hở" }
        ]
    },
    {
        maDV: "CT_17",
        ...
        danhSachICD: [
            ...
            { maICD: "H66.3", tenBenh: "Viêm tai giữa nung mủ mạn khác viêm tai giữa mủ mạn khác" },
            { maICD: "H66.4", tenBenh: "Viêm tai giữa nung mủ không đặc hiệu viêm tai giữa mủ không đặc hiệu" },
            ...
            { maICD: "H80.0", tenBenh: "Xốp xơ tai xâm lấn cửa sổ bầu dục làm bít tắc" },
            { maICD: "H80.1", tenBenh: "Xốp xơ tai xâm lấn cửa sổ bầu dục bít lấp" },
            { maICD: "H80.2", tenBenh: "Xốp xơ ốc tai" },
            { maICD: "H80.8", tenBenh: "Xốp xơ tai khác" },
            { maICD: "H80.9", tenBenh: "Xơ nhĩ không đặc hiệu xốp xơ tai không đặc hiệu" },
